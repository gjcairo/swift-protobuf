...
struct ProtobufUnittest_SwiftJSONTest {
  ...
  var repeatedNullValue: [InternalSwiftProtobuf.Google_Protobuf_NullValue] = []
...
extension ProtobufUnittest_SwiftJSONTest: InternalSwiftProtobuf.Message, InternalSwiftProtobuf._MessageImplementationBase, InternalSwiftProtobuf._ProtoNameProviding {
