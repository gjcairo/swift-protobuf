...
extension ProtobufUnittest_MapWellKnownTypes: InternalSwiftProtobuf.Message, InternalSwiftProtobuf._MessageImplementationBase, InternalSwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: InternalSwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_Any>.self, value: &_storage._anyField)
        case 2: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_Api>.self, value: &_storage._apiField)
        case 3: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_Duration>.self, value: &_storage._durationField)
        case 4: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_Empty>.self, value: &_storage._emptyField)
        case 5: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_FieldMask>.self, value: &_storage._fieldMaskField)
        case 6: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_SourceContext>.self, value: &_storage._sourceContextField)
        case 7: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_Struct>.self, value: &_storage._structField)
        case 8: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_Timestamp>.self, value: &_storage._timestampField)
        case 9: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_Type>.self, value: &_storage._typeField)
        case 10: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_DoubleValue>.self, value: &_storage._doubleField)
        case 11: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_FloatValue>.self, value: &_storage._floatField)
        case 12: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_Int64Value>.self, value: &_storage._int64Field)
        case 13: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_UInt64Value>.self, value: &_storage._uint64Field)
        case 14: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_Int32Value>.self, value: &_storage._int32Field)
        case 15: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_UInt32Value>.self, value: &_storage._uint32Field)
        case 16: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_BoolValue>.self, value: &_storage._boolField)
        case 17: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_StringValue>.self, value: &_storage._stringField)
        case 18: try decoder.decodeMapField(fieldType: InternalSwiftProtobuf._ProtobufMessageMap<InternalSwiftProtobuf.ProtobufInt32,InternalSwiftProtobuf.Google_Protobuf_BytesValue>.self, value: &_storage._bytesField)
        default: break
        }
      }
    }
