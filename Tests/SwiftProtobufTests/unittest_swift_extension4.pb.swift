...
let Ext4UnittestSwiftExtension4_Extensions: InternalSwiftProtobuf.SimpleExtensionMap = [
  Ext4Extensions_b,
  Ext4Extensions_C,
...
let Ext4Extensions_b = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufString>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
  _protobuf_fieldNumber: 420,
  fieldName: "protobuf_unittest.extend4.b"
)

let Ext4Extensions_C = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalGroupExtensionField<Ext4C>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
...
extension Ext4MyMessage {
  enum Extensions {
    ...
    static let C = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalGroupExtensionField<Ext4MyMessage.C>, ProtobufUnittest_Extend_Foo.Bar.Baz>(
...
extension Ext4MyMessage: InternalSwiftProtobuf.Message, InternalSwiftProtobuf._MessageImplementationBase, InternalSwiftProtobuf._ProtoNameProviding {
...
extension Ext4MyMessage.C: InternalSwiftProtobuf.Message, InternalSwiftProtobuf._MessageImplementationBase, InternalSwiftProtobuf._ProtoNameProviding {
...
extension Ext4C: InternalSwiftProtobuf.Message, InternalSwiftProtobuf._MessageImplementationBase, InternalSwiftProtobuf._ProtoNameProviding {
