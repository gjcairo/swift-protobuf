...
let UnittestSwiftReservedExt_Extensions: InternalSwiftProtobuf.SimpleExtensionMap = [
...
/// Will get _p added because it has no package/swift prefix to scope and
/// would otherwise be a problem when added to the message.
let Extensions_debugDescription = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
  _protobuf_fieldNumber: 1000,
  fieldName: "debugDescription"
)

/// These will get _p added for the same reasoning.
let Extensions_as = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
  _protobuf_fieldNumber: 1012,
  fieldName: "as"
)

let Extensions_var = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
  _protobuf_fieldNumber: 1013,
  fieldName: "var"
)

let Extensions_try = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
  _protobuf_fieldNumber: 1014,
  fieldName: "try"
)

let Extensions_do = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
  _protobuf_fieldNumber: 1015,
  fieldName: "do"
)

let Extensions_nil = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
...
extension SwiftReservedTestExt2 {
  enum Extensions {
    static let hashValue_ = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
    ...
    /// Reserved words, since these end up in the "enum Extensions", they
    /// can't just be get their names, and sanitation kicks.
    static let `as` = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
      _protobuf_fieldNumber: 1022,
      fieldName: "SwiftReservedTestExt2.as"
    )

    static let `var` = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
      _protobuf_fieldNumber: 1023,
      fieldName: "SwiftReservedTestExt2.var"
    )

    static let `try` = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
      _protobuf_fieldNumber: 1024,
      fieldName: "SwiftReservedTestExt2.try"
    )

    static let `do` = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
      _protobuf_fieldNumber: 1025,
      fieldName: "SwiftReservedTestExt2.do"
    )

    static let `nil` = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufBool>, ProtobufUnittest_SwiftReservedTest.TypeMessage>(
...
extension SwiftReservedTestExt2: InternalSwiftProtobuf.Message, InternalSwiftProtobuf._MessageImplementationBase, InternalSwiftProtobuf._ProtoNameProviding {
