...
struct Swift_Protobuf_TestFieldOrderings: InternalSwiftProtobuf.ExtensibleMessage {
...
struct Swift_Protobuf_OneofTraversalGeneration: InternalSwiftProtobuf.ExtensibleMessage {
  // InternalSwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
let Swift_Protobuf_UnittestSwiftFieldorder_Extensions: InternalSwiftProtobuf.SimpleExtensionMap = [
...
let Swift_Protobuf_Extensions_my_extension_string = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufString>, Swift_Protobuf_TestFieldOrderings>(
  _protobuf_fieldNumber: 50,
  fieldName: "swift.protobuf.my_extension_string"
)

let Swift_Protobuf_Extensions_my_extension_int = InternalSwiftProtobuf.MessageExtension<InternalSwiftProtobuf.OptionalExtensionField<InternalSwiftProtobuf.ProtobufInt32>, Swift_Protobuf_TestFieldOrderings>(
...
extension Swift_Protobuf_TestFieldOrderings: InternalSwiftProtobuf.Message, InternalSwiftProtobuf._MessageImplementationBase, InternalSwiftProtobuf._ProtoNameProviding {
...
extension Swift_Protobuf_TestFieldOrderings.NestedMessage: InternalSwiftProtobuf.Message, InternalSwiftProtobuf._MessageImplementationBase, InternalSwiftProtobuf._ProtoNameProviding {
...
extension Swift_Protobuf_OneofTraversalGeneration: InternalSwiftProtobuf.Message, InternalSwiftProtobuf._MessageImplementationBase, InternalSwiftProtobuf._ProtoNameProviding {
