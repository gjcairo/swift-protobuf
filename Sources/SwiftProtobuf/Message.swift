...
///
/// In general, use `InternalSwiftProtobuf.Message` instead when you need a variable or
/// argument that can hold any type of message. Occasionally, you can use
/// `InternalSwiftProtobuf.Message & Equatable` or `InternalSwiftProtobuf.Message & Hashable` as
